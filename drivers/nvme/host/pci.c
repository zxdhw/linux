...
// static void __nvme_pci_complete_rq(struct request *req)
// {
// 	struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
...
// static void nvme_pci_complete_rq_magazine(struct request *req, struct nvme_queue *nvmeq)
// {
